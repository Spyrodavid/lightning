...
const displaySave = ctx.createImageData(noiseSave)
...
for (let y = 0; y < height; y++) {
    for (let x = 0; x < width; x++) {
        ...
        curNoiseVal = noise.simplex3(x / 200, y / 200, Date.now() / 10000)
...
function MainLoop() {
    ...
    ctx.putImageData(noiseSave, 0, 0);
